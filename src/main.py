...
if __name__ == "__main__":
    ...
    if "Context" in model_name.reader:
        args.data_appendix = "_context%d%d%d" % (
            args.include_item_features,
            args.include_user_features,
    ...
    log_args = [
        ...
        args.dataset + args.data_appendix,
